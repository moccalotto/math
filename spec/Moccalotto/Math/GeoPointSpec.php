...
class GeoPointSpec extends ObjectBehavior
{
    ...
    public function it_converts_lat_to_floats()
    {
        $this->beConstructedWith(0, 0);
        $this->lat()->shouldReturn(0.0);
    }

    public function it_converts_lon_to_floats()
    {
        $this->beConstructedWith(0, 0);
        $this->lon()->shouldReturn(0.0);
    }

    public function it_can_measure_distance_between_geo_points_with_good_precision()
    {
        $this->beConstructedWith(0, 0);
